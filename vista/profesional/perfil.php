    ...
    <body>
        ...
        <div class="container">
            <div class="py-5 text-center">
                <h2>Profesional de la salud mental</h2>
                ...
                <div class="col-md-5 col-lg-4 order-md-last">
                    ...
                    <ul class="list-group mb-3">
                        <li class="list-group-item d-flex justify-content-between lh-sm">
                            <div>
                                <h6 class="my-0">Articulos</h6>
                                <small class="text-body-secondary">Subir articulos especializados</small>
                            </div>
                            <a href="articulo.php"><img src="../../recursos/ir.png" alt="seleccionador"></a>
                        </li>
                    </ul>
                </div>
                    ...
                    <form action="../../controlador/controladorProfesionalEditar.php" method="POST" class="needs-validation" novalidate>
                        ...
                        <?php if(!is_null($usuarios)): ?>
                            <?php foreach($usuarios as $usuarioU): ?>
                                <?php $profesionales = Profesional::buscarIdP($_SESSION['profesional']); ?>
                                    ...
                                    <?php foreach($profesionales as $profesionalU): ?>
                                        ...
                                        <?php if(!is_null($direcciones)): ?>
                                            <?php foreach($direcciones as $direccionU): ?>
                                                ...
                                                <input type="hidden" id="id" name="id" value="<?php echo $_SESSION['profesional']; ?>">
                                            <?php endforeach; ?>
                                        <?php endif; ?>
                                    <?php endforeach; ?>
                                <?php endif; ?>
